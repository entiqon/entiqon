...
- Introduced **helpers** package for reusable validation utilities.
    ...
    - Independent test file (`identifier_test.go`) with exhaustive valid/invalid cases.
    - Includes `doc.go` (dialect-agnostic rules for now, dialect-specific in future) and `README.md`.
